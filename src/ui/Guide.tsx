...
const SECTIONS: Section[] = [
  ...
  { title: 'Status & attention', body: <>Trusted Codex hooks report running, waiting, interrupted, and completed turns. Review the project and <code>/hooks</code> trust prompts when asked. <b>Status unverified</b> means the app has not verified hooks for this invocation. Codex keeps workspace-write sandbox access. The optional Skip approval prompts checkbox disables command approvals for that agent; project and hook trust still apply.</> },
